...
coroutine.resume(coroutine.create(function()
	...
	game:GetService("CoreGui").RobloxGui.ControlFrame.TopLeftControl:Remove()
end))
...
local RobloxGui = CoreGui.RobloxGui.ControlFrame;
...
pcall(function() game:GetService("ScriptContext").ScriptsDisabled = false end)
pcall(function() settings().Diagnostics:LegacyScriptMode() end)
pcall(function() game:GetService("InsertService"):SetBaseSetsUrl("https://sets.pizzaboxer.xyz/Game/Tools/InsertAsset.ashx?nsets=10&type=base") end)
pcall(function() game:GetService("InsertService"):SetUserSetsUrl("https://sets.pizzaboxer.xyz/Game/Tools/InsertAsset.ashx?nsets=20&type=user&userid=%d") end)
pcall(function() game:GetService("InsertService"):SetCollectionUrl("https://sets.pizzaboxer.xyz/Game/Tools/InsertAsset.ashx?sid=%d") end)
pcall(function() game:GetService("InsertService"):SetAssetUrl("https://assetdelivery.roblox.com/v1/asset/?id=%d") end)
pcall(function() game:GetService("InsertService"):SetAssetVersionUrl("https://assetdelivery.roblox.com/v1/asset/?id=%d") end)
...
pcall(function() game:GetService("ScriptInformationProvider"):SetAssetUrl("https://assetdelivery.roblox.com/v1/asset/") end)
